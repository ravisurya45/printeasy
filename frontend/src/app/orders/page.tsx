        ...
        <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-200">
          <div className="flex items-center justify-between border-b pb-6 mb-6">
            <div>
              ...
              <h3 className="text-xl font-bold mt-2">Order #ORD-9482</h3>
            ...
            <div className="text-right">
              ...
              <p className="text-slate-500 text-sm">Paid via UPI</p>
            </div>
          </div>
          
          <div className="flex justify-between items-center text-slate-600">
            <p><strong>Document:</strong> my_assignment.pdf (10 pages)</p>
            <p><strong>Settings:</strong> Black & White, A4, No Binding</p>
          </div>
